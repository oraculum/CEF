...
namespace BoletoNet.EDI.Banco
{
    ...
    public class TRegistroEDI_Caixa_Retorno : TRegistroEDI
    {
        ...
        public TRegistroEDI_Caixa_Retorno()
        {
            ...
            this._CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0018, 016, 0, string.Empty, ' ')); //018-033
            this._CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0034, 004, 0, string.Empty, ' ')); //034-037
		...
		public override void DecodificarLinha()
		{
            ...
            this._CodigoEmpresa = (string)this._CamposEDI[3].ValorNatural;
            ...
            this._IdentificacaoTituloCaixa_NossoNumero = (string)this._CamposEDI[6].ValorNatural;
            this._Brancos2 = (string)this._CamposEDI[7].ValorNatural;
            this._CodigoMotivoRejeicao = (string)this._CamposEDI[8].ValorNatural;
            this._IdentificacaoOperacao = (string)this._CamposEDI[9].ValorNatural;
            this._CodigoCarteira = (string)this._CamposEDI[10].ValorNatural;
            this._CodigoOcorrencia = (string)this._CamposEDI[11].ValorNatural;
            this._DataOcorrencia = (string)this._CamposEDI[12].ValorNatural;
            this._NumeroDocumento = (string)this._CamposEDI[13].ValorNatural;
            this._Brancos3 = (string)this._CamposEDI[14].ValorNatural;
            this._DataVencimentoTitulo = (string)this._CamposEDI[15].ValorNatural;
            this._ValorTitulo = (string)this._CamposEDI[16].ValorNatural;
            this._CodigoBancoCobrador = (string)this._CamposEDI[17].ValorNatural;
            this._CodigoAgenciaCobradora = (string)this._CamposEDI[18].ValorNatural;
            this._EspecieTitulo = (string)this._CamposEDI[19].ValorNatural;
            this._ValorDespesasCobranca = (string)this._CamposEDI[20].ValorNatural;
            this._TipoLiquidacao = (string)this._CamposEDI[21].ValorNatural;
            this._FormaPagamentoUtilizada = (string)this._CamposEDI[22].ValorNatural;
            this._FloatNegociado = (string)this._CamposEDI[23].ValorNatural;
            this._DataDebitoTarifaLiquidacao = (string)this._CamposEDI[24].ValorNatural;
            this._Brancos4 = (string)this._CamposEDI[25].ValorNatural;
            this._ValorIOF = (string)this._CamposEDI[26].ValorNatural;
            this._ValorAbatimentoConcedido = (string)this._CamposEDI[27].ValorNatural;
            this._ValorDescontoConcedido = (string)this._CamposEDI[28].ValorNatural;
            this._ValorPago = (string)this._CamposEDI[29].ValorNatural;
            this._ValorJuros = (string)this._CamposEDI[30].ValorNatural;
            this._ValorMulta = (string)this._CamposEDI[31].ValorNatural;
            this._CodigoMoeda = (string)this._CamposEDI[32].ValorNatural;
            this._DataCreditoConta = (string)this._CamposEDI[33].ValorNatural;
